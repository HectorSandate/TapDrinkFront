...
export const LampContainer = ({
  ...
  return (
    ...
    className={cn(
        "relative flex min-h-screen bg-gray-100 sm:min-h-[1080px] md:min-h-[1080px] lg:min-h-[1080px] xl:min-h-[1080px] items-start justify-start overflow-hidden bg-slate-950 w-full rounded-md z-0 pt-36 pl-[60px]",
        className
      )}
    ...
    >
      <div className="relative flex w-full  scale-y-125 items-center justify-center isolate z-0 ">
        <motion.div
          ...
          style={{
            backgroundImage: `conic-gradient(var(--conic-position), var(--tw-gradient-stops))`, //QAQUIIIIIIIII
          }}
