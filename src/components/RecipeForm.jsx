  ...
  return (
    ...
    <div className="flex space-x-4">
      <div>
        ...
        <input type="text" name="nombre" value={formData.nombre} onChange={handleChange} className="mt-1 block px-3 py-2 rounded-md inputs-style" />
      </div>
      <div>
        <label htmlFor="duracion" className="block title-style">Duración</label>
        <input type="text" name="duracion" value={formData.duracion} onChange={handleChange} className="mt-1 block px-3 py-2 rounded-md inputs-style" />
      </div>
      <div>
      <label htmlFor="categoria" className="block title-style">Categoría</label>
      <input type="text" name="categoria" value={formData.categoria} onChange={handleChange} className="mt-1 block px-2 py-2 rounded-md inputs-style" />
    </div>
    </div>
    ...
    <div className="mb-4">
      ...
      <input type="file" id="image" name="image" className="img-style rounded-md py-2 px-3" onChange={handleImageChange} />
    </div>
