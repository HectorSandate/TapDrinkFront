  ...
  return (
    ...
    >
      <Container fluid>
        ...
        <button
          className="text-white   font-medium rounded-lg text-sm px-5 py-1.5 ps-8  focus:outline-none"
          type="button"
          ...
          <div className="py-4 overflow-y-auto">
            <ul className="space-y-2 font-medium">
              ...
              <li>
                ...
                >
                  <NavDropdown.Item href="/agregarLicor">
                    Agregar Licor
                  </NavDropdown.Item>
                  <NavDropdown.Item href="/verLicor">
                    Ver Licores
                  </NavDropdown.Item>
                </NavDropdown>
              </li>
