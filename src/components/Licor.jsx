            ...
            <CardContainer className="inter-var">
                <CardBody className="card relative bg-gray-50 dark:bg-black rounded-xl border p-6">
                    <CardItem translateZ="100" className="w-full">
                        <img src={imageUrl} className="card-img-top object-cover rounded-xl h-60 w-full" alt="Licor" />
                    </CardItem>
                    ...
                    <div className="flex justify-between items-center mt-20">
                        <CardItem translateZ={20} as="button" className="px-4 py-2 rounded-xl bg-black dark:bg-white text-white dark:text-black txt-xs font-bold" onClick={() => onClick(licorId)}>
                            Ver licor
                        </CardItem>
            ...
            {isModalOpen && (
                <div className="fixed top-0 bottom-0 right-0 left-0 bg-gray-900 bg-opacity-70 z-50 flex justify-center items-center">
                    <div ref={modalRef} className="bg-white p-12 rounded-lg max-w-md">
                        <h3 className="text-xl font-bold text-gray-500 dark:text-gray-400 mb-12">Eliminar licor</h3>
                        <p className="text-gray-500 dark:text-gray-400 mb-12">¿Estás seguro de que deseas eliminar este licor?</p>
            ...
            {isConfirmModalOpen && (
                <div className="fixed top-0 bottom-0 right-0 left-0 bg-gray-900 bg-opacity-70 z-50 flex justify-center items-center">
                    <div className="bg-white p-12 rounded-lg max-w-md">
                        ...
                        <p className="text-gray-500 dark:text-gray-400 mb-5">Esta acción eliminará el licor de forma temporal. ¿Estás seguro?</p>
